...
<div class="wrapper">
   ...
   <div class="container-fluid">
    ...
    <?php 
            ...
            ?>
    <p class="fs-2 fw-lighter" style="font-style: italic ;">Equipment Report View
     </p>
     <div style="max-height:500px;overflow-y:scroll">
       <table class="table table-striped "  >
         ...
         <tbody>
         <?php 
           $sqlaccounts ="SELECT * from unit_reports where reported_by = '$name' order by no desc  ";
         ...
         ?>
           ...
           <td><input type="text" class="no" value="<?php  echo $rows['No'] ?>" size="3px" readonly></td>
            <td><input type="text" class="class" name="class_<?= $rows['No'] ?>" value="<?php  echo $rows['classification'] ?>" size="8px" readonly></td>
             ...
             <td><input type="submit" id="btn"  class="fixed" value="View">
                            <!-- temporaryonly -->
